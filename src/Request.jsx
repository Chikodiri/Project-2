...
const requests = {
    ...
    popular: `${base_uri}movie/popular?api_key=${key}&language=en-US&page=1`,
    top: `${base_uri}movie/top_rated?api_key=${key}&language=en-US&page=1`,
    nowPlaying: `${base_uri}movie/now_playing?api_key=${key}&language=en-US&page=1`,
    upcoming: `${base_uri}movie/upcoming?api_key=${key}&language=en-US&page=1`,
};
